...
import com.micro.cache.MicroCircle;
import com.micro.cache.MicroPoint;
...
public class Z{
	 ...
	 * @return
	 */
	public static boolean pointOnCircle(MicroPoint point,MicroCircle c1,MicroCircle c2){
	 ...
	 * @return
	 */
	public static boolean pointOnCircle(MicroPoint point,MicroCircle c1,MicroCircle c2,float offset){
	 ...
	 * @return
	 */
	public static boolean pointInCircle(MicroPoint point,MicroCircle circle){
	 ...
	 * @return
	 */
	public static double getDistance(MicroPoint p1,MicroPoint p2) {  
	 ...
	 * @return
	 */
	public static List<MicroPoint> circleCrossoverPoint(MicroCircle circle1,MicroCircle circle2){
		List<MicroPoint> pointList = new ArrayList<MicroPoint>();
		//第一个圆的参数方程:
		// x = r1 * cosCita + x1
		// y = r1 * sinCita + y1
		...
		Set<MicroPoint> pointSet = new HashSet<MicroPoint>();
		MicroPoint p1_1 = new MicroPoint(x_1,y_1_1);
		if(pointOnCircle(p1_1,circle1,circle2)){
			pointSet.add(p1_1);
		}

		MicroPoint p1_2 = new MicroPoint(x_1,y_1_2);
		...
		MicroPoint p2_1 = new MicroPoint(x_2,y_2_1);
		if(pointOnCircle(p2_1,circle1,circle2)){
			pointSet.add(p2_1);
		}

		MicroPoint p2_2 = new MicroPoint(x_2,y_2_2);
		if(pointOnCircle(p2_2,circle1,circle2)){
			pointSet.add(p2_2);
		}
		for(Iterator<MicroPoint> iter = pointSet.iterator();iter.hasNext();){   
			MicroPoint point = (MicroPoint)iter.next();   
			pointList.add(point);
		}  
		return pointList;
	}
