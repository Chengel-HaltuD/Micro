 ...
 * 
 * @ClassName: R
 * @Description: R是ResourceUtils资源工具类
 * @Author：Chengel_HaltuD
 * @Date：2015-5-30 下午3:02:36
 * @version V1.0
 *
 */
public class R {
	...
	/**
	 * same to {@link R#geFileFromAssets(Context, String)}, but return type is List<String>
	 * 
	 * @param context
	 * @param fileName
	 * @return
	...
	/**
	 * same to {@link R#geFileFromRaw(Context, int)}, but return type is List<String>
	 * 
	 * @param context
	 * @param resId
	 * @return
