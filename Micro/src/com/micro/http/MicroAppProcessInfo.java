...
/**
 * 
 * @ClassName: MicroAppProcessInfo
 * @Description: 描述：进程信息
 * @Author：Chengel_HaltuD
 * @Date：2015-5-30 下午2:49:37
 * @version V1.0
 *
 */
public class MicroAppProcessInfo implements Comparable<MicroAppProcessInfo>{
	 ...
	 * @param uid the uid
	 */
	public MicroAppProcessInfo(String processName, int pid, int uid) {
		super();
	 ...
	 */
	@Override
	public int compareTo(MicroAppProcessInfo another) {
