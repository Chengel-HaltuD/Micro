...
/**
 * 
 * @ClassName: MicroBinaryHttpResponseListener
 * @Description: 描述：Http二进制响应监听器
 * @Author：Chengel_HaltuD
 * @Date：2015-5-30 下午2:50:21
 * @version V1.0
 *
 */
public abstract class MicroBinaryHttpResponseListener extends MicroHttpResponseListener{
	
    /**
     * 构造.
     */
	public MicroBinaryHttpResponseListener() {
		super();
	}
